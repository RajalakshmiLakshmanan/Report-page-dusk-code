...
class FormActivityTest extends DuskTestCase
{
    public function setUp():void
    {
        ...
        $this->browse(
            function (Browser $browser) {
                ...
                ->clickReports()
                ->clickLink('Form Activity','a');
            }
        );
    }
    /**
     * Test if the Form Activity page loads and displays all the parameters in the page.
     *
     * @return void
     */
    public function test_if_form_activity_page_loads_and_displays_all_the_parameters_in_page()
    {
        $this->browse(function (Browser $browser) {
    $browser->assertSee('Form Activity')
            ->assertSee('Period')
            ...
            ->assertSee('Requests / Form');
            
        });
    } 
   /**
     * Test if the user can filter the Form Activity Report
     *
     * @return void
     */
    public function test_if_user_can_filter_the_form_activity_Report()
    {
        $this->browse(function (Browser $browser) {
    $browser->select('period', 'last-12-weeks')
            ->pause(2000);
    $browser->select('type', 'patient');
    $browser->pause(2000)
    ...
    /**
     * Test if the user can export the form activity Report
     *
     * @return void
     */
    public function test_if_user_can_export_the_form_activity_Report()
    {
        $this->browse(function (Browser $browser) {
